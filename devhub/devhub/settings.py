...
SECRET_KEY = 'django-insecure-lijgnu$ybc)a7c%bqw=_4)imzl4_&pec&yv@ldjeo60c#kknd*'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'core.context_processors.notifications_context',  # <-- add this
...
AUTH_USER_MODEL = 'core.PythonUser'
LOGIN_URL = 'login'
